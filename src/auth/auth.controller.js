...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (registerUserDto) {
        ...
        AuthController_1.prototype.login = function (loginUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.login(loginUserDto)];
                });
            });
        };
