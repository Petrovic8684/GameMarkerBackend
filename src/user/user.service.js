                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (id !== this.authUserService.user.id)
                                throw new common_1.ForbiddenException('Only the owner of this account can update it');
